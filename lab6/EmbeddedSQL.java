...
public class EmbeddedSQL {
   ...
   public static void Query1(EmbeddedSQL esql){
      try{
         ...
         String query = "SELECT COUNT(*) FROM Suppliers S, Parts P, Catalog C WHERE S.sid = C.sid AND P.pid = C.pid GROUP BY S.sid";
   ...
   public static void Query2(EmbeddedSQL esql){
      try{
         String query = "SELECT COUNT(*) FROM Suppliers S, Parts P, Catalog C WHERE S.sid = C.sid AND P.pid = C.pid GROUP BY S.sid, S.sname HAVING COUNT(*) > 2;";
   ...
   public static void Query5(EmbeddedSQL esql){
      try{
         ...
         String query = 
            ...
            "C.cost < ";  // Concatenating the dynamic cost value into the query string
   ...
   public static void Query6(EmbeddedSQL esql){
      try{
         ...
         String query = 
            ...
            "WHERE P.pid = C.pid AND S.sid = C.sid AND P.pname = '";  // Concatenating the dynamic cost value into the query string
